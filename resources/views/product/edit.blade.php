                ...
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{route('admin.products.update', ['id' => $product->id ])}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group control-group control-video increment-video" >
                                    <input type="file" name="fileVideo" >
                                    <div class="input-group-btn"> 
                                        <!-- <button class="btn btn-success btn-video" type="button"><i class="glyphicon glyphicon-plus"></i>Add</button> -->
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            <label for="description" class="col-md-12 col-form-label text-md-center">{{ __('Description Below') }}</label>

                            <div class="col-md-12">
                                <textarea style="min-height: 500px" id="description" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="description" value="{{ old('description') }}" required autofocus>{{($product->description) ? $product->description : old('description')}}</textarea>
