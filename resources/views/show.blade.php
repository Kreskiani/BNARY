            ...
            <div class="card">
                ...
                <div class="card-body row">
                    ...
                    <div class="col-md-8" style="min-height: 500px">
                        ...
                        <div class="mt-2">
                            <a href="https://facebook.com/sharer/sharer.php?u{{route('detail', ['id'=>$product->id])}}" class="social-button" target="_blank"> Share Facebook</a>
                            |
                            <a href="https://twitter.com/intent/tweet?text=my share text&amp;url={{route('detail', ['id'=>$product->id])}}" class="social-button" target="_blank"> Share Twitter</a>
                            |
                            <a href="https://linkedin.com/shareArticle?mini=true&amp;title=my share text&amp;sumary=dit is de linkedin summary" class="social-button" target="_blank">Share Linkedin</a>
                            |
                            <a href="https://wa.me/?text={{route('detail', ['id'=>$product->id])}}" class="social-button" target="_blank">Share Whatsapp</a>
                        </div>
                        <hr>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <video width="100%" controls>
                                          <source src="{{asset('videos/'.$product->video_url)}}" type="video/mp4">
