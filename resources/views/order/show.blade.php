            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">  
                                <p class="text text-info">Alamat Pengiriman : {!! strip_tags($order->shipping_address) !!}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">  
                                <p class="text text-info">Kode Pos : {{ $order->zip_code }}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">  
                                <p class="text text-info">Harga Total : Rp. {{ number_format($order->total_price) }}</p>
                            </div>
                        </div>
